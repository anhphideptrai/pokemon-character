...
- (void)copyDatabase {
    ...
    _databasePath = [documentsDirectory stringByAppendingPathComponent:@"PokemonNew.db"];
    
    if ([fileManager fileExistsAtPath:_databasePath] == NO) {
        NSString *resourcePath = [[NSBundle mainBundle] pathForResource:@"PokemonNew" ofType:@"sqlite"];
